...
export default function CommunityGalleryLightbox({
  ...
  return (
    ...
    >
      <div
        className="relative flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-3xl border border-white/10 bg-[#07080a]"
          ...
          {hasMultipleImages && (
            <>
              <button
                ...
                onClick={onPrevious}
                className="absolute left-4 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-black/50 text-white/75 transition hover:border-yellow-300/40 hover:bg-yellow-400/10 hover:text-yellow-200"
              >
                <ChevronLeft size={24} />
              </button>
              ...
              <button
                ...
                onClick={onNext}
                className="absolute right-4 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-black/50 text-white/75 transition hover:border-yellow-300/40 hover:bg-yellow-400/10 hover:text-yellow-200"
              >
